    ...
    <div class="space-y-8">
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <LockIcon v-else class="h-5 w-5 text-gray-600" />
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="font-medium text-gray-900">Show Learning Progress</p>
                        </div>
                        <p class="mt-1 text-xs text-gray-500">
                    ...
                    <div class="ml-4">
                        <input type="checkbox" v-model="settings.show_progress"
                            :disabled="settings.profile_visibility !== 'public'"
                            class="h-4 w-4 text-indigo-600 border-gray-300 rounded disabled:opacity-50 disabled:cursor-not-allowed" />
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="font-medium text-gray-900">Allow Direct Messages</p>
                        </div>
                        <p class="mt-1 text-xs text-gray-500">
        ...
        <div class="rounded-md bg-gray-50 p-4">
            <div class="flex">
                ...
                <div class="ml-3 flex-1">
                    <h3 class="text-sm font-medium text-gray-900">What's Visible When Public?</h3>
        ...
        <div class="flex justify-end">
            <button @click="saveSettings" :disabled="isSaving || isLoading"
                class="inline-flex items-center px-6 py-2 bg-indigo-600 text-white text-sm font-medium rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed">
