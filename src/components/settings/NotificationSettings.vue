<template>
  <div class="space-y-6">
    ...
    <div v-else class="divide-y divide-gray-200 border-t border-b border-gray-200">
      ...
      <div class="flex items-start py-4">
        <div class="flex-1">
          <label class="text-sm font-medium text-gray-900">Achievement Alerts</label>
          <p class="text-xs text-gray-500">
      ...
      <div class="flex items-start py-4">
        <div class="flex-1">
          <label class="text-sm font-medium text-gray-900">Platform Updates</label>
          <p class="text-xs text-gray-500">
    ...
    <div class="rounded-md bg-gray-50 p-4">
      <div class="flex">
        ...
        <div class="ml-3 flex-1">
          <h3 class="text-sm font-medium text-gray-900">About Notifications</h3>
