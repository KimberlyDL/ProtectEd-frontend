<template>
  <div class="space-y-6">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
          <tr v-for="guardian in guardians" :key="guardian.id" class="hover:bg-gray-50">
            ...
            <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
              <button @click="openModal(guardian)" class="text-indigo-600 hover:text-indigo-900 mr-4">
                Edit
              </button>
    ...
    <div v-else class="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
      ...
      <h3 class="mt-2 text-sm font-medium text-gray-900">No guardians added</h3>
            ...
            <form @submit.prevent="saveGuardian" class="space-y-4">
              ...
              <div class="mt-6 flex justify-end gap-3 pt-4 border-t">
                ...
                <button type="submit" :disabled="isSaving"
                  class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed">
