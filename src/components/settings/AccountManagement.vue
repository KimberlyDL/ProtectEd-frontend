        ...
        <section>
            ...
            <div class="mt-6 max-w-md space-y-4">
                ...
                <button @click="changePassword" :disabled="!isPasswordFormValid || isChangingPassword"
                    class="inline-flex items-center bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed">
